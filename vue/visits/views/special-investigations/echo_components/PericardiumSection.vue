  ...
  <div class="card mb-3">
    ...
    <div class="card-body" v-if="visible">
      ...
      <div class="alert alert-warning p-1 m-0">
        ...
        <AutoCompleteTextBox
            search-dispatch-name="echo_searchPericardiumRemarks"
            add-dispatch-name="echo_addPericardiumRemark"
            field-name="value"
            v-model="remarkToAdd"
            @input="onAdd"
        />
...
export default {
  ...
  computed: {
    fillableRemarks() {
      return _.filter(this.allEchoRemarks['PERICARDIUM'], {'fillable': 'Y'});
    }
