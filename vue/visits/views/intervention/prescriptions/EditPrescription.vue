<template>
  ...
  <div>
    ...
    <div class="card shadow shadow-sm mb-3" v-else>
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <textarea rows="2" class="form-control" v-model="selectedPrescription.remarks"
                    placeholder="Add a remark about the prescription..."></textarea>
        </div>


        <div class="d-flex justify-content-between mb-3">
          <div>
            <PrintPrescription :prescription-id="selectedPrescription.id"/>
          </div>
          <button class="btn btn-success" @click="onUpdatePrescription()">
            <img src="/assets/images/actions/save.svg" class="icon-16" alt="Update this prescription"> Update
          </button>
        </div>
          ...
          <tr v-for="item in selectedPrescription.prescription_items" :key="item.id"
            ...
            <td class="text-right align-middle">
              <div class="d-flex align-items-center" style="gap: 10px">
                ...
                <div>
                  <button class="btn btn-tiny btn-outline-danger" @click="onDeletePrescriptionItem(item)"
                          v-show="showDeleteItemById === item.id">
    ...
    <ModalWindow :visible="modalDeleteVisible" @close="modalDeleteVisible = false">
      ...
      <p class="text-center">All associated items such as drug details associated with this prescription will be
        lost.</p>
...
export default {
  ...
  components: {PrintPrescription, AutoCompleteTextBox, AlertArea, DateField, ModalWindow},
    ...
    async onUpdatePrescription() {
      ...
      try {
        ...
        const params = {
          ...
          remarks: voca.capitalize(this.selectedPrescription.remarks),
        };
    ...
    * */
    ...
    async onPrint() {
      try {
        ...
        errorMessageBox('Failed to fetch latest prescription updates');
      }
    },
