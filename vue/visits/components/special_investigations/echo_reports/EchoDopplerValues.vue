<template>
  ...
  <div class="report-section" @mouseover="inputVisible = true" @mouseleave="inputVisible = false">
    ...
    <div class="alert alert-dark shadow shadow-sm p-2">
      ...
      <CommonView :all-values="allValues" :visit-values="visitValues" label="Doppler" @add="onAdd" @new="onNew('echo-doppler-value.php')"/>
...
export default {
  ...
  data() {
    return {
      ...
      visitValues : [],
      selectedItem: -1,
      REPORT_TYPE : 'echo_doppler_values'
    }
  }, /* DATA */
