...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new (vuex__WEBPACK_IMPORTED_MODULE_1___default().Store)({
  ...
  actions: {
    ...
    UPDATE: function UPDATE(_ref2, item) {
      ...
      return new Promise(function (resolve, reject) {
        $.post("".concat(getSiteURL(), "/api/update/echo/echo-value.php"), item).done(function (response) {
    ...
    DELETE: function DELETE(_ref4, id) {
      ...
      return new Promise(function (resolve, reject) {
        $.post("".concat(getSiteURL(), "/api/delete/echo/echo-value.php"), {
          id: id
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./vue/echo/values/store.js");
