...
/* harmony import */ var _components_EditDrug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/EditDrug */ "./vue/drugs/components/EditDrug.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "ManageDrugs",
  components: {
    SaveDrug: _components_SaveDrug__WEBPACK_IMPORTED_MODULE_2__.default,
    EditDrug: _components_EditDrug__WEBPACK_IMPORTED_MODULE_1__.default
  },
  data: function data() {
    return {};
  },
  ...
  methods: {
    onSelectDrug: function onSelectDrug(drug) {
      this.$store.commit("setSelectedDrug", drug);
      this.$store.commit("setPanelModeEdit");
    },
    onAddNewDrug: function onAddNewDrug() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                params = {
                  id: _this.selectedDrug.id,
                  drug_name: _this.selectedDrug.drug_name,
                  remarks: _this.selectedDrug.remarks
                };
                _context.next = 4;
                return _this.$store.dispatch("drugs_update", params);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                _context.prev = 8;
                _context.t0 = _context["catch"](0);
                (0,_common_bootbox_dialogs__WEBPACK_IMPORTED_MODULE_1__.errorMessageBox)("Failed to save");
...
/***/ "./vue/_common/bootbox_dialogs.js":
/*!****************************************!*\
  !*** ./vue/_common/bootbox_dialogs.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "successMessageBox": () => /* binding */ successMessageBox,
    ...
    _c("div", { staticClass: "container-fluid" }, [
      _c("div", { staticClass: "row" }, [
            ...
            _c("div", { staticClass: "card-body" }, [
              _c(
                ...
                [
                  ...
                  _c(
                    "tbody",
                    _vm._l(_vm.drugsList, function(drug) {
                      return _c("tr", { key: drug.id }, [
                        ...
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(drug.remarks))])
                      ])
                    }),
                    0
                  )
        ...
        _c(
          ...
          [
            _vm.panelMode === "EDIT" ? _c("EditDrug") : _vm._e(),
            _vm._v(" "),
            _vm.panelMode === "ADD" ? _c("SaveDrug") : _vm._e()
          ],
          1
        )
      ])
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./vue/drugs/manage.app.js");
