...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _common_components_RichEditorV2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../_common/components/RichEditorV2 */ "./vue/_common/components/RichEditorV2.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "EditDisease",
  components: {
    RichEditorV2: _common_components_RichEditorV2__WEBPACK_IMPORTED_MODULE_0__.default
  },
  props: [],
  data: function data() {
    return {
  ...
  methods: {
    onClickUpdate: function onClickUpdate() {
      ...
      this.$store.dispatch('updateDisease', disease).then(function (r) {
    ...
    * */
    ...
    onClickDelete: function onClickDelete() {
      ...
      this.$store.dispatch('deleteDisease', this.disease).then(function (r) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new (vuex__WEBPACK_IMPORTED_MODULE_1___default().Store)({
  ...
  actions: {
    ...
    * */
    saveDisease: function saveDisease(_ref2, disease) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        $.post("".concat(getSiteURL(), "/api/save/disease.php"), params).done(function (r) {
    ...
    * */
    updateDisease: function updateDisease(_ref3, disease) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        $.post("".concat(getSiteURL(), "/api/update/disease.php"), params).done(function (r) {
          dispatch('fetchDiseases');
          resolve(r);
        }).fail(function (e) {
          reject(e);
    ...
    * */
    deleteDisease: function deleteDisease(_ref4, disease) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        $.post("".concat(getSiteURL(), "/api/delete/disease.php"), params).done(function (r) {
          dispatch('fetchDiseases');
          resolve();
        }).fail(function (e) {
          reject(e);
    ...
    setSelectedDisease: function setSelectedDisease(_ref5, disease) {
          ...
          _c("div", { staticClass: "col" }, [
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("input", {
                ...
                staticClass: "form-control",
                class: {
                  "is-invalid": !_vm.isValidForm,
                  "is-valid": _vm.isValidForm
                },
                attrs: { type: "text" },
                domProps: { value: _vm.disease.disease },
                on: {
